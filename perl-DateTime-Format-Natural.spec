...
Source0  : https://cpan.metacpan.org/authors/id/S/SC/SCHUBIGER/DateTime-Format-Natural-1.21.tar.gz
...
%prep
%setup -q -n DateTime-Format-Natural-1.21
cd %{_builddir}/DateTime-Format-Natural-1.21
pushd ..
cp -a DateTime-Format-Natural-1.21 buildavx2
popd
...
/usr/share/man/man3/DateTime::Format::Natural::Duration::Checks.3
