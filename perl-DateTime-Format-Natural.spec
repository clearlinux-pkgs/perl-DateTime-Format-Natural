...
Source0  : https://cpan.metacpan.org/authors/id/S/SC/SCHUBIGER/DateTime-Format-Natural-1.16.tar.gz
...
%prep
%setup -q -n DateTime-Format-Natural-1.16
cd %{_builddir}/DateTime-Format-Natural-1.16
