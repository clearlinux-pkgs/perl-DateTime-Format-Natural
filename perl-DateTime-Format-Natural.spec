...
Source0  : https://cpan.metacpan.org/authors/id/S/SC/SCHUBIGER/DateTime-Format-Natural-1.10.tar.gz
...
%prep
%setup -q -n DateTime-Format-Natural-1.10
cd %{_builddir}/DateTime-Format-Natural-1.10
