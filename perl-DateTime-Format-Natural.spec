...
Source0  : https://cpan.metacpan.org/authors/id/S/SC/SCHUBIGER/DateTime-Format-Natural-1.11.tar.gz
...
%prep
%setup -q -n DateTime-Format-Natural-1.11
cd %{_builddir}/DateTime-Format-Natural-1.11
